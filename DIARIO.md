...
O buzzer continua sendo o problema da montagem. Em vez do bip, sai um clique curto, parecido com o de um mouse, e ele aparece em todo toque, inclusive naqueles em que o programa não manda a peça tocar. O João testou o buzzer à parte, num Arduino, e ele também não apitou; a hipótese dele é que o disco cerâmico da peça esteja danificado, e a peça vai ser trocada.
