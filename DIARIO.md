...
Este programa também ainda não rodou na placa: depende da montagem da protoboard. A gravação deve acontecer até sábado, 19/09.
...
**O roteiro de bancada do teste de rádio foi escrito dentro das duas tarefas de teste (16/09).** Quem roda os testes é o João, que está com a placa, e o Caio escreveu o passo a passo para ser seguido sem conhecer o funcionamento interno do aparelho. O hotspot tem que ser ligado antes da placa, porque é ao ligar que ela procura o hotspot e escolhe o canal da própria rede. Enquanto a conexão segura se abre, a página do celular pode ficar vermelha, e isso não se anota como queda: queda é o celular sair da rede do aparelho depois de pedida a medição, e o monitor registra quanto tempo ele levou para voltar. Cada teste roda mais de uma vez, três rodadas no de memória e duas por celular no do painel, e o pior resultado decide. Com um iPhone e um Android, os dois celulares trocam de papel no meio do teste do painel, e assim os dois sistemas são testados sem um terceiro aparelho.

Ao conferir o roteiro contra o programa, o Caio corrigiu duas frases do monitor. A falha por endereço do banco não encontrado imprimia lixo de memória no lugar da explicação, e a linha que confirma a conexão segura mostrava o endereço do banco, que não pode ir para o comentário público em que o João cola o trecho.

**A solda do leitor de crachás ficou para sábado, e as gravações da semana foram reorganizadas em torno dela (17/09).** Os pinos do leitor precisam ser soldados antes de ele ir para a protoboard, e o João, que está com as peças, só consegue fazer isso no sábado, 19/09. O LED e o buzzer não dependem da solda: a montagem dessa parte, a checagem do buzzer e a gravação do programa que testa as cores e o bip acontecem até sábado, assim que o ambiente de compilação estiver funcionando no computador do João. O programa que lê o crachá é gravado no mesmo sábado, depois da solda. A tarde de domingo, 20/09, continua reservada ao programa do sinal de presença e ao que mantém os registros depois de um reinício, e os dois agora dependem de a solda sair no sábado.

**O enunciado da entrega saiu, e a semana foi replanejada em torno dele (20/09).** O professor publicou o enunciado no domingo. O envio fecha na terça, 22/09, às 23h59, e a equipe precisa apresentar o protótipo funcionando na aula do mesmo dia, rodando pelo menos um teste diante dele, que compara o que está na mesa com o que foi documentado. O critério é a cadeia inteira, do sensor ao processamento e ao atuador, com o teste e a evidência de cada etapa. Além dos testes, o enunciado pede a descrição de como sensor, processamento e atuador interagem e o código com as alterações feitas desde a entrega anterior.

O Caio levantou com o João o que já tinha sido feito com as peças. O programa já compilava e subia para a placa no computador do João, a montagem estava pela metade e nenhum teste tinha rodado, porque a solda dos pinos do leitor de crachás não aconteceu no sábado. As gravações foram todas para a segunda, 21/09, na ordem em que uma libera a outra, e o teste que junta leitor, luz e bip num mesmo ciclo ficou marcado como o que não pode faltar, por ser o único que mostra a cadeia inteira de uma vez. No mesmo dia, o Caio escreveu as três partes do documento que não dependem de teste: a descrição da integração, o código produzido desde a entrega anterior e o que fica fora desta entrega, com o motivo.

**As peças obedeceram pela primeira vez, e a memória do microcontrolador passou no teste da conexão segura (21/09).** O João gravou na placa, pelo próprio computador, os primeiros programas do projeto. No que põe à prova as peças de aviso, as três cores do LED acenderam na ordem e bateram com o nome impresso no monitor, e ele enviou o vídeo ao grupo. O bip saiu muito baixo e com um som estranho, audível só de perto. O buzzer é de 5 V, e o João o ligou por um transistor, como a especificação previa para esse caso; o som não melhorou, e a peça vai ser trocada. A suspeita, ainda a conferir, é que ela seja um buzzer passivo, que só estala quando recebe tensão constante, e não o buzzer ativo que o projeto prevê. A montagem também saiu com resistores de 300 Ω no LED, onde a especificação previa 220 Ω, e as duas diferenças foram registradas na especificação.

No teste de memória, o microcontrolador manteve a própria rede no ar, conectou ao hotspot do celular e abriu a conexão segura com o banco na nuvem com 236,5 KB livres, contra os 40 KB que a conexão exige. Era a medição capaz de derrubar sozinha o modo simultâneo, e ela passou com folga. Antes dela, o Caio precisou reativar o banco, que o serviço gratuito tinha pausado por falta de uso. O teste do painel do professor, que verifica se o celular continua na página quando o aparelho muda de canal para acompanhar o hotspot, ainda não teve rodada válida: na única feita, o aparelho já estava conectado ao hotspot, e a mudança de canal não aconteceu. A escolha entre o modo simultâneo e a alternância espera essa rodada. Os três testes que leem crachá esperam a solda dos pinos do leitor, que o João leva para fazer ainda na segunda.

**O leitor de crachás funcionou, e o aparelho fechou pela primeira vez o ciclo do crachá ao aviso (21 e 22/09).** O João soldou os pinos do leitor na noite de segunda e gravou em seguida os dois programas que dependiam dele. No primeiro, que só lê, cada um dos três crachás da equipe devolveu sempre o mesmo número: o cartão e o chaveiro, com 4 bytes, e uma tag adesiva, com 7. As tags são difíceis de ler, e a adesiva mais que as outras, porque a antena dela é pequena e o leitor só a detecta bem encostada.

No programa do sinal de presença, o cartão registrou no primeiro toque, com duas piscadas verdes. Encostado de novo depois de alguns segundos, recebeu uma piscada só e não foi registrado outra vez, e o toque repetido logo em seguida foi ignorado, como manda a regra dos cinco segundos. O chaveiro, encostado depois, registrou normalmente. Do começo da conversa com o leitor até o aviso passaram cerca de 29 milésimos de segundo, contra os 200 que a especificação admite. A tag de 7 bytes ainda não tinha passado por esse programa.

O buzzer continua sendo o problema da montagem. Em vez do bip, sai um clique curto, parecido com o de um mouse, e ele aparece sempre que o LED acende, inclusive quando o crachá já registrado recebe a piscada sem som, momento em que o programa não manda a peça tocar. No toque ignorado, em que o LED fica apagado, não há clique. O João testou o buzzer à parte, num Arduino, e ele também não apitou; a hipótese dele é que o disco cerâmico da peça esteja danificado, e a peça vai ser trocada.

Na manhã de terça, com o envio marcado para a noite, o Caio assumiu a documentação dos testes, que era do Gabriel, e passou a escrevê-la direto no rascunho do documento, em vez de num arquivo separado que repetiria o mesmo texto.

**As presenças sobreviveram ao corte de energia, e o documento da entrega foi fechado (22/09).** Perto do meio-dia de terça, o João rodou o programa que mantém os registros depois de um reinício. Usou o cartão e o chaveiro, e não os trinta toques previstos, porque são os dois crachás que o leitor detecta com folga. O cartão foi registrado, a placa foi desligada e religada, e o chaveiro foi registrado depois disso. Encostados de novo, os dois foram reconhecidos como já registrados e nada foi gravado, de modo que o cartão, gravado antes do corte, continuou registrado depois dele. O arquivo terminou com uma linha por crachá, e ele mesmo prova que houve reinício: cada linha guarda o tempo desde que a placa ligou, e a do chaveiro, gravada depois, marca menos tempo que a do cartão. O teste entrou no documento como obtido em parte, com o que ficou de fora declarado: os trinta toques, a anotação do momento do corte e a linha que o programa imprime ao ligar.

A tag adesiva, de 7 bytes, não chegou a passar pelos programas que registram presença. A antena dela é pequena, o leitor só a detecta bem encostada, e o João sugeriu comprar a mesma tag em formato de cartão, com antena maior. O documento declara como não obtido o registro com essa tag; a leitura do número dela já tinha sido provada no programa que só lê.

O documento reúne a foto do protótipo tirada pelo João, a descrição da integração, o código produzido desde a entrega anterior, a checagem das peças e cinco testes com o resultado esperado ao lado do obtido, e o que fica para depois, com o motivo. Três testes aparecem incompletos: o do painel não teve rodada válida, e o do crachá de 7 bytes e o da queda de energia saíram em parte. A entrega pede o resultado obtido, e esconder o que não rodou seria o erro. O documento foi enviado no Teams em 22/09, acompanhado dos vídeos e das fotos que servem de evidência aos testes.

**O protótipo foi aprovado na demonstração, e o teste do painel do professor passou na mesma aula (22/09).** Na aula de terça, a equipe apresentou o protótipo com o programa do sinal de presença gravado na placa, e o professor o aprovou. Ele perguntou se o buzzer era ativo ou passivo e sugeriu que a falta de som viesse da alimentação em 5 V; o João respondeu que a peça, ligada à parte num Arduino, também não funcionou, e que suspeita do disco cerâmico.

Depois da demonstração, com dois celulares na mesma sala, o grupo refez o teste que ficou de fora do documento: saber se o celular do professor continua no painel quando o aparelho se conecta ao hotspot e muda o canal da própria rede. O Android do João serviu de hotspot e o iPhone do Cauã fez o papel do professor, e depois os papéis se inverteram, em duas rodadas por celular. Nas quatro, a página continuou aberta sem pedir login de novo, e nenhum celular saiu da rede do aparelho. O resultado ficou registrado pelo relato do grupo, sem o trecho do monitor serial.
