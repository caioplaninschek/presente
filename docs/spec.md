...
**Lacunas conhecidas (11/09, ampliadas em 13/09).** Sete itens **não têm task** e não vão ter antes da Entrega 05 — nenhum cabe na janela. Ficam listados para que a ausência seja escolha declarada, e não descuido:
