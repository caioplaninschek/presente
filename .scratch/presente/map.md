...
- **A execução saiu daqui em 11/09.** A quebra em epics por entrega, os vértices e o grafo de dependência vivem em `.scratch/prototipo/graph.md`, e as issues de atribuição estão no GitHub, da #5 em diante. Este mapa continua dono só dos fios de decisão que sobraram: ~~o veredito do ticket 09 e o ticket 08, reaberto pelo R19~~ os itens 2 e 3 do ticket 09, sobre o portal cativo. O veredito saiu em 22/09 (Plano A, R45), e o ticket 08 fechou junto. A metade de RLS do ticket 06 fechou em 13/09, na #21 (R33–R35).
