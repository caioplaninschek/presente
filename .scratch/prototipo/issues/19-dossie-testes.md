...
~~docs/testes-22-09.md~~ A seção 3 do `docs/entregas/entrega-05/entrega-05-rascunho.md` (22/09), com uma seção por teste (1, 2, 8, 7c, 7d), evidência versionada em docs/assets/testes/, e a razão de os testes 3 a 6 não entrarem.
